...
public class DistClient implements Watcher, AsyncCallback.StatCallback, AsyncCallback.DataCallback
{
    ...
    public void process(WatchedEvent e)
    {
        ...
        if(e.getType() == Watcher.Event.EventType.None) // This seems to be the event type associated with connections.
        {
            ...
            if(e.getPath() == null && e.getState() ==  Watcher.Event.KeeperState.SyncConnected && taskNodeName == null)
            {
                try
                {
                    ...
                    String p = zk.create(tasksPath + "/task-", dTaskSerial, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
                    taskNodeName = p.substring(p.lastIndexOf('/') + 1);
                    ...
                    String resultPath = resultsPath + "/" + taskNodeName;
                    zk.exists(resultPath, this, this, null);
                }
        ...
        else if(e.getType() == Watcher.Event.EventType.NodeCreated && e.getPath().equals(resultsPath + "/" + taskNodeName))
        {
            ...
            zk.getData(resultsPath + "/" + taskNodeName, null, this, null);
        }
    }
    ...
    public void processResult(int rc, String path, Object ctx, Stat stat)
    {
        ...
        switch(Code.get(rc))
        {
            ...
            case NONODE:
                ...
                zk.exists(resultsPath + "/" + taskNodeName, this, null, null);
                break;
    ...
    public void processResult(int rc, String path, Object ctx, byte[] data, Stat stat)
    {
        ...
        zk.delete(resultsPath + "/" + taskNodeName, -1, null, null);
        zk.delete(tasksPath + "/" + taskNodeName, -1, null, null);
